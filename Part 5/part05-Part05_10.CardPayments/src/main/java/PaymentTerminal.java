public class PaymentTerminal {
    ...
    private static final double AFFORDABLE_PRICE = 2.50; // price of affordable meal
    private static final double HEARTY_PRICE = 4.30; // price of hearty meal
    ...
    public double eatAffordably(double payment) {
        ...
        if (payment >= AFFORDABLE_PRICE) {
            ...
            double change = payment - AFFORDABLE_PRICE;
            return change;
        }
        return payment;
    }
    ...
    public double eatHeartily(double payment) {
        ...
        if (payment >= HEARTY_PRICE) {
            heartyMeals++;
            money = money + HEARTY_PRICE;
            double change = payment - HEARTY_PRICE;
            return change;
        }
        return payment;
    }
    ...
    public boolean eatAffordably(PaymentCard card) {
        ...
        if (card.balance() >= AFFORDABLE_PRICE) affordableMeals++;
    ...
    public boolean eatHeartily(PaymentCard card) {
        ...
        if (card.balance() >= HEARTY_PRICE) heartyMeals++;
